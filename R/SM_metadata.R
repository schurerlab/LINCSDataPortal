...
{ 
  ...
  url <- httr::modify_url("http://dev3.ccs.miami.edu:8080", path = paste("/dcic/api/fetchentities?searchTerm=entityName:",xnew,"&fields=lincsidentifier,entityName,SM_Alternative_Name,category,source,SM_Category,SM_InChi_Parent,SM_SMILES_Parent",sep = ""))
  resp <- httr::GET(url)
